...
import com.quiz.model.search.core.Scroll;
import com.quiz.model.search.core.Search;
import com.quiz.model.search.core.Sort;
...
public class BasePersistenceImpl<T extends BaseEntity, K extends Serializable> implements BasePersistence<T, K> {
    ...
    private Criterion createCriterion(com.quiz.model.search.core.Filter filter) {
    ...
    private Criterion[] createCriterionArray(Collection<com.quiz.model.search.core.Filter> filters) {
